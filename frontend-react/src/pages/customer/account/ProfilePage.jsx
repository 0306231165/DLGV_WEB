...
const ProfilePage = () => {
  ...
  const validate = () => {
    ...
    if (!form.so_dien_thoai.trim())
      e.so_dien_thoai = "Vui lòng nhập số điện thoại.";
    return e;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true); // ← đừng quên dòng này
    setServerError("");
    try {
      ...
      const msg =
        ...
        "Lỗi khi lưu thông tin. Vui lòng thử lại.";
  ...
  return (
    <div className="flex flex-col">
      ...
      {toast && (
        <div
          className={`fixed top-6 right-6 z-[100] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-xl border text-sm font-semibold transition-all
      ...
      <div className="p-8 border-b border-outline-variant/20">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left mt-2">
            ...
            <div
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 ${tierStyle.bg} border ${tierStyle.border} ${tierStyle.text} rounded-full shadow-sm`}
            >
              <span
                className="material-symbols-outlined text-[18px]"
                style={{ fontVariationSettings: "'FILL' 1" }}
            ...
            <p className="text-sm text-on-surface-variant mt-2 max-w-md">
              Cập nhật thông tin cá nhân để chúng tôi có thể phục vụ tốt hơn và
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              {errors.ho_ten && (
                <p className="text-xs text-error">{errors.ho_ten}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-on-surface-variant/70">
                Email không thể thay đổi để đảm bảo bảo mật.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("so_dien_thoai", e.target.value)
                  }
                  className={`w-full h-12 pl-12 pr-4 rounded-xl border bg-surface-bright focus:bg-surface-container-lowest focus:ring-1 outline-none transition-all text-sm text-on-surface shadow-sm
              ...
              {errors.so_dien_thoai && (
                <p className="text-xs text-error">{errors.so_dien_thoai}</p>
              )}
            </div>
              ...
              <div className="flex gap-6 mt-1">
                {["Nam", "Nữ", "Khác"].map((opt) => (
                  ...
                  >
                    ...
                    >
                      <div
                        className={`w-2.5 h-2.5 rounded-full bg-primary transition-transform ${form.gioi_tinh === opt ? "scale-100" : "scale-0"}`}
                      />
                    </div>
                    <span
                      onClick={() => handleChange("gioi_tinh", opt)}
