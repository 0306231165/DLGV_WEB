...
export default function PartnerLogin() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const data = await authApi.loginNhanVien({
          ...
          <div className="hidden md:flex md:w-1/2 relative min-h-[580px] flex-col justify-between p-12 bg-emerald-600 overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-black text-white mb-4 leading-snug">
                Cổng thông tin Đối tác giúp việc
              </h2>
              <p className="text-emerald-100 text-base max-w-sm">
                Đăng nhập để nhận lịch làm việc, quản lý ví thu nhập và cập nhật
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20">
                ...
                <div>
                  <p className="text-white text-sm font-bold">
                    Thu nhập ổn định & Tự do
                  </p>
                  <p className="text-emerald-100 text-xs opacity-90">
                    Đồng hành cùng hơn 2,000 nhân sự chuyên nghiệp
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center bg-white/80">
            <div className="mb-8 text-center md:text-left">
              ...
              <p className="text-sm text-slate-500 font-medium">
                Vui lòng điền tài khoản nhân viên để tiếp tục
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleLoginSubmit}>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 bg-slate-50 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all outline-none text-slate-800 text-sm disabled:opacity-60"
                    id="email"
                    type="text"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-11 pr-12 py-3.5 rounded-xl border border-slate-200 bg-slate-50 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all outline-none text-slate-800 text-sm disabled:opacity-60"
                    id="password"
              ...
              {error && (
                <div className="flex items-center gap-3 bg-rose-50 border border-rose-200 rounded-xl px-4 py-3">
                  <span className="material-symbols-outlined text-rose-500 text-xl shrink-0">
                    error
                  </span>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm tracking-wide shadow-md shadow-emerald-600/10 hover:shadow-lg transition-all active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
                    <svg
