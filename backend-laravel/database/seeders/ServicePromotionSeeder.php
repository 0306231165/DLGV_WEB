...
class ServicePromotionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('KhuyenMai')->insert([
            ['id' => 1, 'ma_code' => 'CLEANTRUST10', 'tag_hien_thi' => 'Người dùng mới', 'tieu_de' => 'Giảm 10% cho khách hàng mới', 'mo_ta' => 'Áp dụng cho mọi dịch vụ', 'dich_vu_id_ap_dung' => null, 'gia_tri_don_toi_thieu' => 0, 'loai_giam_gia' => 'PhanTram', 'gia_tri_giam' => 10, 'giam_toi_da' => 50000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 1, 'tong_luot_luu_toi_da' => 1000, 'tong_luot_dung_toi_da_toan_san' => 5000, 'trang_thai' => true],
            ['id' => 2, 'ma_code' => 'FAMILY50K', 'tag_hien_thi' => 'Gia đình', 'tieu_de' => 'Giảm 50K dịch vụ Gia đình', 'mo_ta' => 'Áp dụng cho Chăm sóc người lớn tuổi, Trông trẻ, Chăm sóc người bệnh', 'dich_vu_id_ap_dung' => 4, 'gia_tri_don_toi_thieu' => 200000, 'loai_giam_gia' => 'TienMat', 'gia_tri_giam' => 50000, 'giam_toi_da' => 50000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 1, 'tong_luot_luu_toi_da' => 500, 'tong_luot_dung_toi_da_toan_san' => 2000, 'trang_thai' => true],
            ['id' => 3, 'ma_code' => 'DEEP200K', 'tag_hien_thi' => 'Tổng vệ sinh', 'tieu_de' => 'Giảm 200K dịch vụ Chuyên sâu', 'mo_ta' => 'Áp dụng cho Dọn sau xây dựng, Tổng vệ sinh', 'dich_vu_id_ap_dung' => 3, 'gia_tri_don_toi_thieu' => 1000000, 'loai_giam_gia' => 'TienMat', 'gia_tri_giam' => 200000, 'giam_toi_da' => 200000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 1, 'tong_luot_luu_toi_da' => 200, 'tong_luot_dung_toi_da_toan_san' => 500, 'trang_thai' => true],
            ['id' => 4, 'ma_code' => 'CARE15', 'tag_hien_thi' => 'Nội thất', 'tieu_de' => 'Giảm 15% làm sạch nội thất', 'mo_ta' => 'Áp dụng giặt nệm, sofa, máy lạnh', 'dich_vu_id_ap_dung' => null, 'gia_tri_don_toi_thieu' => 400000, 'loai_giam_gia' => 'PhanTram', 'gia_tri_giam' => 15, 'giam_toi_da' => 80000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 1, 'tong_luot_luu_toi_da' => 500, 'tong_luot_dung_toi_da_toan_san' => 1500, 'trang_thai' => true],
            ['id' => 5, 'ma_code' => 'CARENEW20', 'tag_hien_thi' => 'Khách mới Nội thất', 'tieu_de' => 'Khách hàng mới Nội thất', 'mo_ta' => 'Giảm 20% cho lần đầu đặt dịch vụ làm sạch nội thất', 'dich_vu_id_ap_dung' => null, 'gia_tri_don_toi_thieu' => 300000, 'loai_giam_gia' => 'PhanTram', 'gia_tri_giam' => 20, 'giam_toi_da' => 100000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 1, 'tong_luot_luu_toi_da' => 500, 'tong_luot_dung_toi_da_toan_san' => 1000, 'trang_thai' => true],
            ['id' => 6, 'ma_code' => 'BUSINESS10', 'tag_hien_thi' => 'Doanh nghiệp', 'tieu_de' => 'Giảm 10% Dọn văn phòng', 'mo_ta' => 'Áp dụng cho Doanh nghiệp', 'dich_vu_id_ap_dung' => 13, 'gia_tri_don_toi_thieu' => 500000, 'loai_giam_gia' => 'PhanTram', 'gia_tri_giam' => 10, 'giam_toi_da' => 200000, 'ngay_bat_dau' => $now, 'ngay_ket_thuc' => $nextMonth, 'luot_dung_moi_khach' => 5, 'tong_luot_luu_toi_da' => 100, 'tong_luot_dung_toi_da_toan_san' => 500, 'trang_thai' => true],
        ]);
        ...
        DB::table('DichVu_LoaiGoi')->insert([
            ...
            ['id' => 13, 'dich_vu_id' => 8, 'loai_goi_id' => 2, 'trang_thai' => true], // Máy lạnh - Gói tháng (Flexible)
            ['id' => 14, 'dich_vu_id' => 9, 'loai_goi_id' => 1, 'trang_thai' => true], // Sofa - Ca lẻ
            ['id' => 15, 'dich_vu_id' => 9, 'loai_goi_id' => 2, 'trang_thai' => true], // Sofa - Gói tháng
            ['id' => 16, 'dich_vu_id' => 10, 'loai_goi_id' => 1, 'trang_thai' => true], // Nệm - Ca lẻ
            ['id' => 17, 'dich_vu_id' => 10, 'loai_goi_id' => 2, 'trang_thai' => true], // Nệm - Gói tháng
            ['id' => 18, 'dich_vu_id' => 11, 'loai_goi_id' => 1, 'trang_thai' => true], // Bếp - Ca lẻ
            ['id' => 19, 'dich_vu_id' => 11, 'loai_goi_id' => 2, 'trang_thai' => true], // Bếp - Gói tháng
            ['id' => 20, 'dich_vu_id' => 12, 'loai_goi_id' => 1, 'trang_thai' => true], // Thảm - Ca lẻ
            ['id' => 21, 'dich_vu_id' => 12, 'loai_goi_id' => 2, 'trang_thai' => true], // Thảm - Gói tháng
